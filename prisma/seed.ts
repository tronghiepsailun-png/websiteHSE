...
const PERMISSION_DEFS = [
  ...
  { key: "forms.view", module: "forms", description: "View and download forms in the form library" },
  { key: "forms.edit", module: "forms", description: "Add, change, replace files of, hide or delete forms in the form library and manage its categories" },
  { key: "ai.use", module: "ai", description: "Use the AI assistant (Q&A and Vietnamese/Chinese translation)" },
  ...
  { key: "incident.download", module: "incident", description: "Export the incident list" },
  ...
  { key: "capa.delete", module: "capa", description: "Delete CAPA items" },
  ...
  { key: "records.edit", module: "records", description: "Add/update compliance record versions and manage the standard-record catalog" },
  { key: "records.manage", module: "records", description: "Legacy alias of records.edit, kept for old role rows" },
  { key: "violation.view", module: "violation", description: "View safety-officer violation log and subsidy report" },
  { key: "violation.edit", module: "violation", description: "Log violations and manage the safety-officer roster/violation-type catalog" },
  { key: "violation.delete", module: "violation", description: "Delete a logged violation or deduction entry" },
  { key: "violation.download", module: "violation", description: "Export the violation/subsidy report" },
  { key: "violation.manage", module: "violation", description: "Legacy alias of violation.edit, kept for old role rows" },
  { key: "workplan.view", module: "workplan", description: "View the HSE work-plan tracker" },
  { key: "workplan.edit", module: "workplan", description: "Create/edit work-plan documents and items" },
  { key: "workplan.delete", module: "workplan", description: "Delete work-plan documents and items" },
  { key: "workplan.manage", module: "workplan", description: "Legacy alias of workplan.edit, kept for old role rows" },
  { key: "inventory.view", module: "inventory", description: "View the equipment inventory and issuance log" },
  { key: "inventory.edit", module: "inventory", description: "Record stock in/out, manage the item catalog" },
  { key: "inventory.delete", module: "inventory", description: "Delete a stock transaction" },
  { key: "inventory.manage", module: "inventory", description: "Legacy alias of inventory.edit, kept for old role rows" },
] as const;
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  viewer: [
    ...
    "training_new_employees.view", "training_incidents.view", "training_materials.view",
  ],
  org_admin: [
    ...
    "docs_hse.view", "docs_environment.view", "procurement.view", "forms.view", "forms.edit", "ai.use",
    "training_new_employees.view", "training_incidents.view", "training_materials.view",
    ...
    "violation.view", "violation.edit", "violation.delete", "violation.download",
    "workplan.view", "workplan.edit", "workplan.delete",
