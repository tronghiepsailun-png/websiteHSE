...
INSERT INTO "new_inventory_transactions" ("createdAt", "department", "id", "itemId", "note", "organizationId", "quantity", "recipientEmployeeId", "recordedById", "transactionDate", "type") SELECT "createdAt", "department", "id", "itemId", "note", "organizationId", "quantity", "recipientEmployeeId", "recordedById", "transactionDate", "type" FROM "inventory_transactions";
