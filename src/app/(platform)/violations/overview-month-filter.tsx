...
// Same pattern as violations/internal/month-filter.tsx, duplicated locally rather than shared
// across route folders — matches how 5s/filters.tsx and lien-de's own filter already do this.
export function OverviewMonthFilter({
  year,
  month,
  options,
}: {
